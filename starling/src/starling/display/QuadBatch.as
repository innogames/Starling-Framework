...
package starling.display
{
    ...
    public class QuadBatch extends DisplayObject
    {
        ...
        public override function dispose():void
        {
			...
			if (mVertexData) mVertexData = null;
            super.dispose();
        }
        ...
        final private function createBuffers():void
        {
       ...
       final private function syncBuffers():void
         ...
         *  display list. */
        final public function renderCustom(mvpMatrix:Matrix, parentAlpha:Number=1.0,
                                     blendMode:String=null):void
        {
			...
			RenderSupport.setProgramByName(programName);
		...
		final public function get tinted():Boolean { return mTinted; }
        final public function get texture():Texture { return mTexture; }
        final public function get smoothing():String { return mSmoothing; }
        final public function get premultipliedAlpha():Boolean { return mVertexData.premultipliedAlpha; }

        final private function get capacity():int { return mVertexData.numVertices / 4; }
