...
package starling.core
{
    ...
    internal class StatsDisplay extends Sprite
    {
		...
		private var _mTextureUsage:int = 0;
        ...
        public function update():void
        {
            ...
            mTextField.text = "FPS: " + mFps.toFixed(mFps < 100 ? 1 : 0) +
							...
							"\nTEX: " + textureUsage; // texture usage // ignore self 
        }
		...
		public function get textureUsage():int
		{
			return _mTextureUsage;
		}
		
		public function set textureUsage(value:int):void
		{
			_mTextureUsage = value;
		}
    }
}
