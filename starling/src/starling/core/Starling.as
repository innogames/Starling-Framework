...
package starling.core
{
    ...
    public class Starling extends EventDispatcher
    {
		...
		[Inline]
        final public function getProgram(name:String):Program3D
        {
            return programs[name] as Program3D;
        }

        /** Indicates if a set of vertex- and fragment-programs is registered under a certain name. */
        final public function hasProgram(name:String):Boolean
        {
            return name in programs;
        }
		[Inline]
        final private function get programs():Dictionary { return contextData[PROGRAM_DATA_NAME]; }
		...
		[Inline]
        final public function get context():Context3D { return mContext; }
         ...
         *  context loss. */
		[Inline]
        final public function get contextData():Dictionary
        {
